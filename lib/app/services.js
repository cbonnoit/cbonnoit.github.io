import { GET_USER_TRIGGERS_ENDPOINT, LIST_CONVERSATIONS_ENDPOINT, SAVE_USER_TRIGGERS_ENDPOINT, SERVICE_HOSTNAME } from "../../cfg/endpoints.js"
 ...
 */
export async function getListConversations (apiKey, maxStartMicroSec=null, forceServiceHostname=null) {
  const hostname = forceServiceHostname ?? SERVICE_HOSTNAME
  const url = `https://${hostname}/${LIST_CONVERSATIONS_ENDPOINT}`
