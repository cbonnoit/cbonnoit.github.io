...
export class CoachingManager {
  ...
  receiveData (data) {
    ...
    if (prompt === 'SUMMARY')
      this._updateSummary(data['value'])
  ...
  /**
   * 
   * @param {Object} partyToIntervals Summary data
   */
  _updateSummary (partyToIntervals) {
    // update active intervals
    for (const [partyId, intervals] of Object.entries(partyToIntervals))
