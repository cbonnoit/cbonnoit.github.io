import { HOST_NAME, PARTY_INFO_ENDPOINT } from '../../cfg/server.js'

export class Namer {
  /**
   * Interface to get names for parties in a conversation
   * @param {String} conversationId Conversation from which to get names
   */
  ...
  async updateNames () {
    ...
    const url = `https://${HOST_NAME}/${PARTY_INFO_ENDPOINT}?${queryString}`
